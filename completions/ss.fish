...
complete -c ss -s "a" -l "all" -d "Display both listening and non-listening (for TCP this means established connections) sockets."
complete -c ss -s "l" -l "listening" -d "Display only listening sockets (these are omitted by default)."
complete -c ss -s "o" -l "options" -d "Show timer information."
complete -c ss -s "e" -l "extended" -d "Show detailed socket information."
complete -c ss -s "m" -l "memory" -d "Show socket memory usage."
complete -c ss -s "p" -l "processes" -d "Show process using socket."
complete -c ss -s "i" -l "info" -d "Show internal TCP information."
complete -c ss -l "tos" -d "Show ToS and priority information."
complete -c ss -l "cgroup" -d "Show cgroup information."
...
complete -c ss -s "N" -l "net" -d "Switch to the specified network namespace name." -x
complete -c ss -s "b" -l "bpf" -d "Show socket classic BPF filters (only administrators are allowed to get these information)."
...
complete -c ss -s "f" -l "family" -d "Display sockets of type FAMILY." -x
complete -c ss -s "A" -l "query" -l "socket" -d "List of socket tables to dump, separated by commas." -x
complete -c ss -s "D" -l "diag" -d "Do not display anything, just dump raw information about TCP sockets to FILE after applying filters." -r
complete -c ss -s "F" -l "filter" -d "Read filter information from FILE." -r
