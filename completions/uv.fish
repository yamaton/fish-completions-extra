...
complete -c uv -n "not __fish_seen_subcommand_from auth run init add remove version sync lock export tree format tool python pip venv build publish cache self help" -s "n" -l "no-cache" -d "Avoid reading from or writing to the cache, instead using a temporary directory for the duration of the operation [env: UV_NO_CACHE=]"
complete -c uv -n "not __fish_seen_subcommand_from auth run init add remove version sync lock export tree format tool python pip venv build publish cache self help" -l "cache-dir" -d "Path to the cache directory [env: UV_CACHE_DIR=]" -r
complete -c uv -n "not __fish_seen_subcommand_from auth run init add remove version sync lock export tree format tool python pip venv build publish cache self help" -l "managed-python" -d "Require use of uv-managed Python versions [env: UV_MANAGED_PYTHON=]"
complete -c uv -n "not __fish_seen_subcommand_from auth run init add remove version sync lock export tree format tool python pip venv build publish cache self help" -l "no-managed-python" -d "Disable use of uv-managed Python versions [env: UV_NO_MANAGED_PYTHON=]"
complete -c uv -n "not __fish_seen_subcommand_from auth run init add remove version sync lock export tree format tool python pip venv build publish cache self help" -l "no-python-downloads" -d "Disable automatic downloads of Python."
complete -c uv -n "not __fish_seen_subcommand_from auth run init add remove version sync lock export tree format tool python pip venv build publish cache self help" -l "color" -d "Control the use of color in output [possible values: auto, always, never]" -x
complete -c uv -n "not __fish_seen_subcommand_from auth run init add remove version sync lock export tree format tool python pip venv build publish cache self help" -l "native-tls" -d "Whether to load TLS certificates from the platform's native store [env: UV_NATIVE_TLS=]"
complete -c uv -n "not __fish_seen_subcommand_from auth run init add remove version sync lock export tree format tool python pip venv build publish cache self help" -l "offline" -d "Disable network access [env: UV_OFFLINE=]"
complete -c uv -n "not __fish_seen_subcommand_from auth run init add remove version sync lock export tree format tool python pip venv build publish cache self help" -l "allow-insecure-host" -d "Allow insecure connections to a host [env: UV_INSECURE_HOST=]" -x
complete -c uv -n "not __fish_seen_subcommand_from auth run init add remove version sync lock export tree format tool python pip venv build publish cache self help" -l "no-progress" -d "Hide all progress outputs [env: UV_NO_PROGRESS=]"
complete -c uv -n "not __fish_seen_subcommand_from auth run init add remove version sync lock export tree format tool python pip venv build publish cache self help" -l "directory" -d "Change to the given directory prior to running the command [env: UV_WORKING_DIR=]" -r
complete -c uv -n "not __fish_seen_subcommand_from auth run init add remove version sync lock export tree format tool python pip venv build publish cache self help" -l "project" -d "Discover a project in the given directory [env: UV_PROJECT=]" -r
complete -c uv -n "not __fish_seen_subcommand_from auth run init add remove version sync lock export tree format tool python pip venv build publish cache self help" -l "config-file" -d "The path to a `uv.toml` file to use for configuration [env: UV_CONFIG_FILE=]" -r
complete -c uv -n "not __fish_seen_subcommand_from auth run init add remove version sync lock export tree format tool python pip venv build publish cache self help" -l "no-config" -d "Avoid discovering configuration files (`pyproject.toml`, `uv.toml`) [env: UV_NO_CONFIG=]"
complete -c uv -n "not __fish_seen_subcommand_from auth run init add remove version sync lock export tree format tool python pip venv build publish cache self help" -s "h" -l "help" -d "Display the concise help for this command"
complete -c uv -n "not __fish_seen_subcommand_from auth run init add remove version sync lock export tree format tool python pip venv build publish cache self help" -s "V" -l "version" -d "Display the uv version"
...
complete -k -c uv -n __fish_use_subcommand -x -a format -d "Format Python code in the project"
...
complete -k -c uv -n __fish_use_subcommand -x -a auth -d "Manage authentication"



complete -c uv -n "__fish_seen_subcommand_from auth" -s "n" -l "no-cache" -d "Avoid reading from or writing to the cache, instead using a temporary directory for the duration of the operation [env: UV_NO_CACHE=]"
complete -c uv -n "__fish_seen_subcommand_from auth" -l "cache-dir" -d "Path to the cache directory [env: UV_CACHE_DIR=]" -r
complete -c uv -n "__fish_seen_subcommand_from auth" -l "managed-python" -d "Require use of uv-managed Python versions [env: UV_MANAGED_PYTHON=]"
complete -c uv -n "__fish_seen_subcommand_from auth" -l "no-managed-python" -d "Disable use of uv-managed Python versions [env: UV_NO_MANAGED_PYTHON=]"
complete -c uv -n "__fish_seen_subcommand_from auth" -l "no-python-downloads" -d "Disable automatic downloads of Python."
complete -c uv -n "__fish_seen_subcommand_from auth" -l "color" -d "Control the use of color in output [possible values: auto, always, never]" -x
complete -c uv -n "__fish_seen_subcommand_from auth" -l "native-tls" -d "Whether to load TLS certificates from the platform's native store [env: UV_NATIVE_TLS=]"
complete -c uv -n "__fish_seen_subcommand_from auth" -l "offline" -d "Disable network access [env: UV_OFFLINE=]"
complete -c uv -n "__fish_seen_subcommand_from auth" -l "allow-insecure-host" -d "Allow insecure connections to a host [env: UV_INSECURE_HOST=]" -x
complete -c uv -n "__fish_seen_subcommand_from auth" -l "no-progress" -d "Hide all progress outputs [env: UV_NO_PROGRESS=]"
complete -c uv -n "__fish_seen_subcommand_from auth" -l "directory" -d "Change to the given directory prior to running the command [env: UV_WORKING_DIR=]" -r
complete -c uv -n "__fish_seen_subcommand_from auth" -l "project" -d "Discover a project in the given directory [env: UV_PROJECT=]" -r
complete -c uv -n "__fish_seen_subcommand_from auth" -l "config-file" -d "The path to a `uv.toml` file to use for configuration [env: UV_CONFIG_FILE=]" -r
complete -c uv -n "__fish_seen_subcommand_from auth" -l "no-config" -d "Avoid discovering configuration files (`pyproject.toml`, `uv.toml`) [env: UV_NO_CONFIG=]"
complete -c uv -n "__fish_seen_subcommand_from auth" -s "h" -l "help" -d "Display the concise help for this command"
...
complete -c uv -n "__fish_seen_subcommand_from run" -l "no-dev" -d "Disable the development dependency group [env: UV_NO_DEV=]"
complete -c uv -n "__fish_seen_subcommand_from run" -l "group" -d "Include dependencies from the specified dependency group" -x
complete -c uv -n "__fish_seen_subcommand_from run" -l "no-group" -d "Disable the specified dependency group [env: UV_NO_GROUP=]" -x
complete -c uv -n "__fish_seen_subcommand_from run" -l "no-default-groups" -d "Ignore the default dependency groups [env: UV_NO_DEFAULT_GROUPS=]"
...
complete -c uv -n "__fish_seen_subcommand_from run" -s "w" -l "with" -d "Run with the given packages installed" -x
...
complete -c uv -n "__fish_seen_subcommand_from run" -l "with-requirements" -d "Run with the packages listed in the given files" -r
complete -c uv -n "__fish_seen_subcommand_from run" -l "isolated" -d "Run the command in an isolated virtual environment [env: UV_ISOLATED=]"
...
complete -c uv -n "__fish_seen_subcommand_from run" -l "exclude-newer-package" -d "Limit candidate packages for specific packages to those that were uploaded prior to the given date" -x
...
complete -c uv -n "__fish_seen_subcommand_from run" -l "no-sources-package" -d "Don't use sources from the `tool.uv.sources` table for the specified packages [env: UV_NO_SOURCES_PACKAGE=]" -x
...
complete -c uv -n "__fish_seen_subcommand_from run" -l "config-settings-package" -d "Settings to pass to the PEP 517 build backend for a specific package, specified as `PACKAGE:KEY=VALUE` pairs" -x
...
complete -c uv -n "__fish_seen_subcommand_from run" -l "native-tls" -d "Whether to load TLS certificates from the platform's native store [env: UV_NATIVE_TLS=]"
...
complete -c uv -n "__fish_seen_subcommand_from run" -l "directory" -d "Change to the given directory prior to running the command [env: UV_WORKING_DIR=]" -r
complete -c uv -n "__fish_seen_subcommand_from run" -l "project" -d "Discover a project in the given directory [env: UV_PROJECT=]" -r
...
complete -c uv -n "__fish_seen_subcommand_from init" -l "build-backend" -d "Initialize a build-backend of choice for the project [env: UV_INIT_BUILD_BACKEND=] [possible values: uv, hatch, flit, pdm, poetry, setuptools, maturin, scikit]" -x
...
complete -c uv -n "__fish_seen_subcommand_from init" -l "native-tls" -d "Whether to load TLS certificates from the platform's native store [env: UV_NATIVE_TLS=]"
...
complete -c uv -n "__fish_seen_subcommand_from init" -l "directory" -d "Change to the given directory prior to running the command [env: UV_WORKING_DIR=]" -r
complete -c uv -n "__fish_seen_subcommand_from init" -l "project" -d "Discover a project in the given directory [env: UV_PROJECT=]" -r
...
complete -c uv -n "__fish_seen_subcommand_from add" -s "r" -l "requirements" -d "Add the packages listed in the given files" -r
...
complete -c uv -n "__fish_seen_subcommand_from add" -l "dev" -d "Add the requirements to the development dependency group [env: UV_DEV=]"
...
complete -c uv -n "__fish_seen_subcommand_from add" -l "raw" -d "Add a dependency as provided"
complete -c uv -n "__fish_seen_subcommand_from add" -l "bounds" -d "The kind of version specifier to use when adding dependencies [possible values: lower, major, minor, exact]" -x
...
complete -c uv -n "__fish_seen_subcommand_from add" -l "lfs" -d "Whether to use Git LFS when adding a dependency from Git"
...
complete -c uv -n "__fish_seen_subcommand_from add" -l "workspace" -d "Add the dependency as a workspace member"
complete -c uv -n "__fish_seen_subcommand_from add" -l "no-workspace" -d "Don't add the dependency as a workspace member"
complete -c uv -n "__fish_seen_subcommand_from add" -l "no-install-project" -d "Do not install the current project"
complete -c uv -n "__fish_seen_subcommand_from add" -l "no-install-workspace" -d "Do not install any workspace members, including the current project"
complete -c uv -n "__fish_seen_subcommand_from add" -l "no-install-local" -d "Do not install local path dependencies"
complete -c uv -n "__fish_seen_subcommand_from add" -l "no-install-package" -d "Do not install the given package(s)" -x
...
complete -c uv -n "__fish_seen_subcommand_from add" -l "exclude-newer-package" -d "Limit candidate packages for specific packages to those that were uploaded prior to the given date" -x
...
complete -c uv -n "__fish_seen_subcommand_from add" -l "no-sources-package" -d "Don't use sources from the `tool.uv.sources` table for the specified packages [env: UV_NO_SOURCES_PACKAGE=]" -x
...
complete -c uv -n "__fish_seen_subcommand_from add" -l "config-settings-package" -d "Settings to pass to the PEP 517 build backend for a specific package, specified as `PACKAGE:KEY=VALUE` pairs" -x
...
complete -c uv -n "__fish_seen_subcommand_from add" -l "native-tls" -d "Whether to load TLS certificates from the platform's native store [env: UV_NATIVE_TLS=]"
...
complete -c uv -n "__fish_seen_subcommand_from add" -l "directory" -d "Change to the given directory prior to running the command [env: UV_WORKING_DIR=]" -r
complete -c uv -n "__fish_seen_subcommand_from add" -l "project" -d "Discover a project in the given directory [env: UV_PROJECT=]" -r
...
complete -c uv -n "__fish_seen_subcommand_from remove" -l "dev" -d "Remove the packages from the development dependency group [env: UV_DEV=]"
...
complete -c uv -n "__fish_seen_subcommand_from remove" -l "exclude-newer-package" -d "Limit candidate packages for specific packages to those that were uploaded prior to the given date" -x
...
complete -c uv -n "__fish_seen_subcommand_from remove" -l "no-sources-package" -d "Don't use sources from the `tool.uv.sources` table for the specified packages [env: UV_NO_SOURCES_PACKAGE=]" -x
...
complete -c uv -n "__fish_seen_subcommand_from remove" -l "config-settings-package" -d "Settings to pass to the PEP 517 build backend for a specific package, specified as `PACKAGE:KEY=VALUE` pairs" -x
...
complete -c uv -n "__fish_seen_subcommand_from remove" -l "native-tls" -d "Whether to load TLS certificates from the platform's native store [env: UV_NATIVE_TLS=]"
...
complete -c uv -n "__fish_seen_subcommand_from remove" -l "directory" -d "Change to the given directory prior to running the command [env: UV_WORKING_DIR=]" -r
complete -c uv -n "__fish_seen_subcommand_from remove" -l "project" -d "Discover a project in the given directory [env: UV_PROJECT=]" -r
...
complete -c uv -n "__fish_seen_subcommand_from version" -l "bump" -d "Update the project version using the given semantics [possible values: major, minor, patch, stable, alpha, beta, rc, post, dev]" -x
...
complete -c uv -n "__fish_seen_subcommand_from version" -l "output-format" -d "The format of the output [default: text] [possible values: text, json]" -x
complete -c uv -n "__fish_seen_subcommand_from version" -l "no-sync" -d "Avoid syncing the virtual environment after re-locking the project [env: UV_NO_SYNC=]"
complete -c uv -n "__fish_seen_subcommand_from version" -l "active" -d "Prefer the active virtual environment over the project's virtual environment"
complete -c uv -n "__fish_seen_subcommand_from version" -l "locked" -d "Assert that the `uv.lock` will remain unchanged [env: UV_LOCKED=]"
complete -c uv -n "__fish_seen_subcommand_from version" -l "frozen" -d "Update the version without re-locking the project [env: UV_FROZEN=]"
complete -c uv -n "__fish_seen_subcommand_from version" -l "package" -d "Update the version of a specific package in the workspace" -x
complete -c uv -n "__fish_seen_subcommand_from version" -l "index" -d "The URLs to use when resolving dependencies, in addition to the default index [env: UV_INDEX=]" -x
complete -c uv -n "__fish_seen_subcommand_from version" -l "default-index" -d "The URL of the default package index (by default: <https://pypi.org/simple>) [env: UV_DEFAULT_INDEX=]" -x
complete -c uv -n "__fish_seen_subcommand_from version" -s "i" -l "index-url" -d "(Deprecated: use `--default-index` instead) The URL of the Python package index (by default: <https://pypi.org/simple>) [env: UV_INDEX_URL=]" -x
complete -c uv -n "__fish_seen_subcommand_from version" -l "extra-index-url" -d "(Deprecated: use `--index` instead) Extra URLs of package indexes to use, in addition to `--index-url` [env: UV_EXTRA_INDEX_URL=]" -x
complete -c uv -n "__fish_seen_subcommand_from version" -s "f" -l "find-links" -d "Locations to search for candidate distributions, in addition to those found in the registry indexes [env: UV_FIND_LINKS=]" -x
complete -c uv -n "__fish_seen_subcommand_from version" -l "no-index" -d "Ignore the registry index (e.g., PyPI), instead relying on direct URL dependencies and those provided via `--find-links`"
complete -c uv -n "__fish_seen_subcommand_from version" -l "index-strategy" -d "The strategy to use when resolving against multiple index URLs [env: UV_INDEX_STRATEGY=] [possible values: first-index, unsafe-first-match, unsafe-best-match]" -x
complete -c uv -n "__fish_seen_subcommand_from version" -l "keyring-provider" -d "Attempt to use `keyring` for authentication for index URLs [env: UV_KEYRING_PROVIDER=] [possible values: disabled, subprocess]" -x
complete -c uv -n "__fish_seen_subcommand_from version" -s "U" -l "upgrade" -d "Allow package upgrades, ignoring pinned versions in any existing output file."
complete -c uv -n "__fish_seen_subcommand_from version" -s "P" -l "upgrade-package" -d "Allow upgrades for a specific package, ignoring pinned versions in any existing output file." -r
complete -c uv -n "__fish_seen_subcommand_from version" -l "resolution" -d "The strategy to use when selecting between the different compatible versions for a given package requirement [env: UV_RESOLUTION=] [possible values: highest, lowest, lowest-direct]" -r
complete -c uv -n "__fish_seen_subcommand_from version" -l "prerelease" -d "The strategy to use when considering pre-release versions [env: UV_PRERELEASE=] [possible values: disallow, allow, if-necessary, explicit, if-necessary-or-explicit]" -x
complete -c uv -n "__fish_seen_subcommand_from version" -l "fork-strategy" -d "The strategy to use when selecting multiple versions of a given package across Python versions and platforms [env: UV_FORK_STRATEGY=] [possible values: fewest, requires-python]" -x
complete -c uv -n "__fish_seen_subcommand_from version" -l "exclude-newer" -d "Limit candidate packages to those that were uploaded prior to the given date [env: UV_EXCLUDE_NEWER=]" -x
complete -c uv -n "__fish_seen_subcommand_from version" -l "exclude-newer-package" -d "Limit candidate packages for specific packages to those that were uploaded prior to the given date" -x
complete -c uv -n "__fish_seen_subcommand_from version" -l "no-sources" -d "Ignore the `tool.uv.sources` table when resolving dependencies."
complete -c uv -n "__fish_seen_subcommand_from version" -l "no-sources-package" -d "Don't use sources from the `tool.uv.sources` table for the specified packages [env: UV_NO_SOURCES_PACKAGE=]" -x
complete -c uv -n "__fish_seen_subcommand_from version" -l "reinstall" -d "Reinstall all packages, regardless of whether they're already installed."
complete -c uv -n "__fish_seen_subcommand_from version" -l "reinstall-package" -d "Reinstall a specific package, regardless of whether it's already installed." -x
complete -c uv -n "__fish_seen_subcommand_from version" -l "link-mode" -d "The method to use when installing packages from the global cache [env: UV_LINK_MODE=] [possible values: clone, copy, hardlink, symlink]" -x
complete -c uv -n "__fish_seen_subcommand_from version" -l "compile-bytecode" -d "Compile Python files to bytecode after installation [env: UV_COMPILE_BYTECODE=]"
complete -c uv -n "__fish_seen_subcommand_from version" -s "C" -l "config-setting" -d "Settings to pass to the PEP 517 build backend, specified as `KEY=VALUE` pairs" -x
complete -c uv -n "__fish_seen_subcommand_from version" -l "config-settings-package" -d "Settings to pass to the PEP 517 build backend for a specific package, specified as `PACKAGE:KEY=VALUE` pairs" -x
complete -c uv -n "__fish_seen_subcommand_from version" -l "no-build-isolation" -d "Disable isolation when building source distributions [env: UV_NO_BUILD_ISOLATION=]"
complete -c uv -n "__fish_seen_subcommand_from version" -l "no-build-isolation-package" -d "Disable isolation when building source distributions for a specific package" -x
complete -c uv -n "__fish_seen_subcommand_from version" -l "no-build" -d "Don't build source distributions [env: UV_NO_BUILD=]"
complete -c uv -n "__fish_seen_subcommand_from version" -l "no-build-package" -d "Don't build source distributions for a specific package [env: UV_NO_BUILD_PACKAGE=]" -x
complete -c uv -n "__fish_seen_subcommand_from version" -l "no-binary" -d "Don't install pre-built wheels [env: UV_NO_BINARY=]"
complete -c uv -n "__fish_seen_subcommand_from version" -l "no-binary-package" -d "Don't install pre-built wheels for a specific package [env: UV_NO_BINARY_PACKAGE=]" -x
...
complete -c uv -n "__fish_seen_subcommand_from version" -l "refresh" -d "Refresh all cached data"
complete -c uv -n "__fish_seen_subcommand_from version" -l "refresh-package" -d "Refresh cached data for a specific package" -x
complete -c uv -n "__fish_seen_subcommand_from version" -s "p" -l "python" -d "The Python interpreter to use for resolving and syncing." -x
...
complete -c uv -n "__fish_seen_subcommand_from version" -l "native-tls" -d "Whether to load TLS certificates from the platform's native store [env: UV_NATIVE_TLS=]"
...
complete -c uv -n "__fish_seen_subcommand_from version" -l "directory" -d "Change to the given directory prior to running the command [env: UV_WORKING_DIR=]" -r
complete -c uv -n "__fish_seen_subcommand_from version" -l "project" -d "Discover a project in the given directory [env: UV_PROJECT=]" -r
...
complete -c uv -n "__fish_seen_subcommand_from sync" -l "output-format" -d "Select the output format [default: text] [possible values: text, json]" -x
...
complete -c uv -n "__fish_seen_subcommand_from sync" -l "no-dev" -d "Disable the development dependency group [env: UV_NO_DEV=]"
...
complete -c uv -n "__fish_seen_subcommand_from sync" -l "no-group" -d "Disable the specified dependency group [env: UV_NO_GROUP=]" -x
complete -c uv -n "__fish_seen_subcommand_from sync" -l "no-default-groups" -d "Ignore the default dependency groups [env: UV_NO_DEFAULT_GROUPS=]"
...
complete -c uv -n "__fish_seen_subcommand_from sync" -l "no-install-local" -d "Do not install local path dependencies"
...
complete -c uv -n "__fish_seen_subcommand_from sync" -l "package" -d "Sync for specific packages in the workspace" -x
...
complete -c uv -n "__fish_seen_subcommand_from sync" -l "python-platform" -d "The platform for which requirements should be installed [possible values: windows, linux, macos, x86_64-pc-windows-msvc, aarch64-pc-windows-msvc, i686-pc-windows-msvc, x86_64-unknown-linux-gnu, aarch64-apple-darwin, x86_64-apple-darwin, aarch64-unknown-linux-gnu, aarch64-unknown-linux-musl, x86_64-unknown-linux-musl, riscv64-unknown-linux, x86_64-manylinux2014, x86_64-manylinux_2_17, x86_64-manylinux_2_28, x86_64-manylinux_2_31, x86_64-manylinux_2_32, x86_64-manylinux_2_33, x86_64-manylinux_2_34, x86_64-manylinux_2_35, x86_64-manylinux_2_36, x86_64-manylinux_2_37, x86_64-manylinux_2_38, x86_64-manylinux_2_39, x86_64-manylinux_2_40, aarch64-manylinux2014, aarch64-manylinux_2_17, aarch64-manylinux_2_28, aarch64-manylinux_2_31, aarch64-manylinux_2_32, aarch64-manylinux_2_33, aarch64-manylinux_2_34, aarch64-manylinux_2_35, aarch64-manylinux_2_36, aarch64-manylinux_2_37, aarch64-manylinux_2_38, aarch64-manylinux_2_39, aarch64-manylinux_2_40, aarch64-linux-android, x86_64-linux-android, wasm32-pyodide2024, arm64-apple-ios, arm64-apple-ios-simulator, x86_64-apple-ios-simulator]" -x
...
complete -c uv -n "__fish_seen_subcommand_from sync" -l "exclude-newer-package" -d "Limit candidate packages for specific packages to those that were uploaded prior to the given date" -x
...
complete -c uv -n "__fish_seen_subcommand_from sync" -l "no-sources-package" -d "Don't use sources from the `tool.uv.sources` table for the specified packages [env: UV_NO_SOURCES_PACKAGE=]" -x
...
complete -c uv -n "__fish_seen_subcommand_from sync" -l "config-settings-package" -d "Settings to pass to the PEP 517 build backend for a specific package, specified as `PACKAGE:KEY=VALUE` pairs" -x
...
complete -c uv -n "__fish_seen_subcommand_from sync" -l "native-tls" -d "Whether to load TLS certificates from the platform's native store [env: UV_NATIVE_TLS=]"
...
complete -c uv -n "__fish_seen_subcommand_from sync" -l "directory" -d "Change to the given directory prior to running the command [env: UV_WORKING_DIR=]" -r
complete -c uv -n "__fish_seen_subcommand_from sync" -l "project" -d "Discover a project in the given directory [env: UV_PROJECT=]" -r
...
complete -c uv -n "__fish_seen_subcommand_from lock" -l "check" -d "Check if the lockfile is up-to-date"
...
complete -c uv -n "__fish_seen_subcommand_from lock" -l "exclude-newer-package" -d "Limit candidate packages for specific packages to those that were uploaded prior to the given date" -x
...
complete -c uv -n "__fish_seen_subcommand_from lock" -l "no-sources-package" -d "Don't use sources from the `tool.uv.sources` table for the specified packages [env: UV_NO_SOURCES_PACKAGE=]" -x
...
complete -c uv -n "__fish_seen_subcommand_from lock" -l "config-settings-package" -d "Settings to pass to the PEP 517 build backend for a specific package, specified as `PACKAGE:KEY=VALUE` pairs" -x
...
complete -c uv -n "__fish_seen_subcommand_from lock" -l "native-tls" -d "Whether to load TLS certificates from the platform's native store [env: UV_NATIVE_TLS=]"
...
complete -c uv -n "__fish_seen_subcommand_from lock" -l "directory" -d "Change to the given directory prior to running the command [env: UV_WORKING_DIR=]" -r
complete -c uv -n "__fish_seen_subcommand_from lock" -l "project" -d "Discover a project in the given directory [env: UV_PROJECT=]" -r
...
complete -c uv -n "__fish_seen_subcommand_from export" -l "format" -d "The format to which `uv.lock` should be exported [possible values: requirements.txt, pylock.toml, cyclonedx1.5]" -x
complete -c uv -n "__fish_seen_subcommand_from export" -l "all-packages" -d "Export the entire workspace"
complete -c uv -n "__fish_seen_subcommand_from export" -l "package" -d "Export the dependencies for specific packages in the workspace" -x
...
complete -c uv -n "__fish_seen_subcommand_from export" -l "no-dev" -d "Disable the development dependency group [env: UV_NO_DEV=]"
...
complete -c uv -n "__fish_seen_subcommand_from export" -l "no-group" -d "Disable the specified dependency group [env: UV_NO_GROUP=]" -x
complete -c uv -n "__fish_seen_subcommand_from export" -l "no-default-groups" -d "Ignore the default dependency groups [env: UV_NO_DEFAULT_GROUPS=]"
...
complete -c uv -n "__fish_seen_subcommand_from export" -l "no-editable" -d "Export any editable dependencies, including the project and any workspace members, as non-editable [env: UV_NO_EDITABLE=]"
...
complete -c uv -n "__fish_seen_subcommand_from export" -l "no-emit-local" -d "Do not include local path dependencies in the exported requirements"
...
complete -c uv -n "__fish_seen_subcommand_from export" -l "exclude-newer-package" -d "Limit candidate packages for specific packages to those that were uploaded prior to the given date" -x
...
complete -c uv -n "__fish_seen_subcommand_from export" -l "no-sources-package" -d "Don't use sources from the `tool.uv.sources` table for the specified packages [env: UV_NO_SOURCES_PACKAGE=]" -x
...
complete -c uv -n "__fish_seen_subcommand_from export" -l "config-settings-package" -d "Settings to pass to the PEP 517 build backend for a specific package, specified as `PACKAGE:KEY=VALUE` pairs" -x
...
complete -c uv -n "__fish_seen_subcommand_from export" -l "native-tls" -d "Whether to load TLS certificates from the platform's native store [env: UV_NATIVE_TLS=]"
...
complete -c uv -n "__fish_seen_subcommand_from export" -l "directory" -d "Change to the given directory prior to running the command [env: UV_WORKING_DIR=]" -r
complete -c uv -n "__fish_seen_subcommand_from export" -l "project" -d "Discover a project in the given directory [env: UV_PROJECT=]" -r
...
complete -c uv -n "__fish_seen_subcommand_from tree" -l "show-sizes" -d "Show compressed wheel sizes for packages in the tree"
complete -c uv -n "__fish_seen_subcommand_from tree" -l "only-dev" -d "Only include the development dependency group"
complete -c uv -n "__fish_seen_subcommand_from tree" -l "no-dev" -d "Disable the development dependency group [env: UV_NO_DEV=]"
complete -c uv -n "__fish_seen_subcommand_from tree" -l "group" -d "Include dependencies from the specified dependency group" -x
complete -c uv -n "__fish_seen_subcommand_from tree" -l "no-group" -d "Disable the specified dependency group [env: UV_NO_GROUP=]" -x
complete -c uv -n "__fish_seen_subcommand_from tree" -l "no-default-groups" -d "Ignore the default dependency groups [env: UV_NO_DEFAULT_GROUPS=]"
...
complete -c uv -n "__fish_seen_subcommand_from tree" -l "python-platform" -d "The platform to use when filtering the tree [possible values: windows, linux, macos, x86_64-pc-windows-msvc, aarch64-pc-windows-msvc, i686-pc-windows-msvc, x86_64-unknown-linux-gnu, aarch64-apple-darwin, x86_64-apple-darwin, aarch64-unknown-linux-gnu, aarch64-unknown-linux-musl, x86_64-unknown-linux-musl, riscv64-unknown-linux, x86_64-manylinux2014, x86_64-manylinux_2_17, x86_64-manylinux_2_28, x86_64-manylinux_2_31, x86_64-manylinux_2_32, x86_64-manylinux_2_33, x86_64-manylinux_2_34, x86_64-manylinux_2_35, x86_64-manylinux_2_36, x86_64-manylinux_2_37, x86_64-manylinux_2_38, x86_64-manylinux_2_39, x86_64-manylinux_2_40, aarch64-manylinux2014, aarch64-manylinux_2_17, aarch64-manylinux_2_28, aarch64-manylinux_2_31, aarch64-manylinux_2_32, aarch64-manylinux_2_33, aarch64-manylinux_2_34, aarch64-manylinux_2_35, aarch64-manylinux_2_36, aarch64-manylinux_2_37, aarch64-manylinux_2_38, aarch64-manylinux_2_39, aarch64-manylinux_2_40, aarch64-linux-android, x86_64-linux-android, wasm32-pyodide2024, arm64-apple-ios, arm64-apple-ios-simulator, x86_64-apple-ios-simulator]" -x
...
complete -c uv -n "__fish_seen_subcommand_from tree" -l "config-settings-package" -d "Settings to pass to the PEP 517 build backend for a specific package, specified as `PACKAGE:KEY=VALUE` pairs" -x
...
complete -c uv -n "__fish_seen_subcommand_from tree" -l "exclude-newer-package" -d "Limit candidate packages for specific packages to those that were uploaded prior to the given date" -x
...
complete -c uv -n "__fish_seen_subcommand_from tree" -l "no-sources-package" -d "Don't use sources from the `tool.uv.sources` table for the specified packages [env: UV_NO_SOURCES_PACKAGE=]" -x
...
complete -c uv -n "__fish_seen_subcommand_from tree" -l "native-tls" -d "Whether to load TLS certificates from the platform's native store [env: UV_NATIVE_TLS=]"
...
complete -c uv -n "__fish_seen_subcommand_from tree" -l "directory" -d "Change to the given directory prior to running the command [env: UV_WORKING_DIR=]" -r
complete -c uv -n "__fish_seen_subcommand_from tree" -l "project" -d "Discover a project in the given directory [env: UV_PROJECT=]" -r
...
complete -c uv -n "__fish_seen_subcommand_from format" -l "check" -d "Check if files are formatted without applying changes"
complete -c uv -n "__fish_seen_subcommand_from format" -l "diff" -d "Show a diff of formatting changes without applying them"
complete -c uv -n "__fish_seen_subcommand_from format" -l "version" -d "The version of Ruff to use for formatting" -x
complete -c uv -n "__fish_seen_subcommand_from format" -l "no-project" -d "Avoid discovering a project or workspace"
complete -c uv -n "__fish_seen_subcommand_from format" -s "n" -l "no-cache" -d "Avoid reading from or writing to the cache, instead using a temporary directory for the duration of the operation [env: UV_NO_CACHE=]"
complete -c uv -n "__fish_seen_subcommand_from format" -l "cache-dir" -d "Path to the cache directory [env: UV_CACHE_DIR=]" -r
complete -c uv -n "__fish_seen_subcommand_from format" -l "managed-python" -d "Require use of uv-managed Python versions [env: UV_MANAGED_PYTHON=]"
complete -c uv -n "__fish_seen_subcommand_from format" -l "no-managed-python" -d "Disable use of uv-managed Python versions [env: UV_NO_MANAGED_PYTHON=]"
complete -c uv -n "__fish_seen_subcommand_from format" -l "no-python-downloads" -d "Disable automatic downloads of Python."
complete -c uv -n "__fish_seen_subcommand_from format" -l "color" -d "Control the use of color in output [possible values: auto, always, never]" -x
complete -c uv -n "__fish_seen_subcommand_from format" -l "native-tls" -d "Whether to load TLS certificates from the platform's native store [env: UV_NATIVE_TLS=]"
complete -c uv -n "__fish_seen_subcommand_from format" -l "offline" -d "Disable network access [env: UV_OFFLINE=]"
complete -c uv -n "__fish_seen_subcommand_from format" -l "allow-insecure-host" -d "Allow insecure connections to a host [env: UV_INSECURE_HOST=]" -x
complete -c uv -n "__fish_seen_subcommand_from format" -l "no-progress" -d "Hide all progress outputs [env: UV_NO_PROGRESS=]"
complete -c uv -n "__fish_seen_subcommand_from format" -l "directory" -d "Change to the given directory prior to running the command [env: UV_WORKING_DIR=]" -r
complete -c uv -n "__fish_seen_subcommand_from format" -l "project" -d "Discover a project in the given directory [env: UV_PROJECT=]" -r
complete -c uv -n "__fish_seen_subcommand_from format" -l "config-file" -d "The path to a `uv.toml` file to use for configuration [env: UV_CONFIG_FILE=]" -r
complete -c uv -n "__fish_seen_subcommand_from format" -l "no-config" -d "Avoid discovering configuration files (`pyproject.toml`, `uv.toml`) [env: UV_NO_CONFIG=]"
complete -c uv -n "__fish_seen_subcommand_from format" -s "h" -l "help" -d "Display the concise help for this command"
...
complete -c uv -n "__fish_seen_subcommand_from tool" -l "native-tls" -d "Whether to load TLS certificates from the platform's native store [env: UV_NATIVE_TLS=]"
...
complete -c uv -n "__fish_seen_subcommand_from tool" -l "directory" -d "Change to the given directory prior to running the command [env: UV_WORKING_DIR=]" -r
complete -c uv -n "__fish_seen_subcommand_from tool" -l "project" -d "Discover a project in the given directory [env: UV_PROJECT=]" -r
...
complete -c uv -n "__fish_seen_subcommand_from python" -l "native-tls" -d "Whether to load TLS certificates from the platform's native store [env: UV_NATIVE_TLS=]"
...
complete -c uv -n "__fish_seen_subcommand_from python" -l "directory" -d "Change to the given directory prior to running the command [env: UV_WORKING_DIR=]" -r
complete -c uv -n "__fish_seen_subcommand_from python" -l "project" -d "Discover a project in the given directory [env: UV_PROJECT=]" -r
...
complete -c uv -n "__fish_seen_subcommand_from pip" -l "native-tls" -d "Whether to load TLS certificates from the platform's native store [env: UV_NATIVE_TLS=]"
...
complete -c uv -n "__fish_seen_subcommand_from pip" -l "directory" -d "Change to the given directory prior to running the command [env: UV_WORKING_DIR=]" -r
complete -c uv -n "__fish_seen_subcommand_from pip" -l "project" -d "Discover a project in the given directory [env: UV_PROJECT=]" -r
...
complete -c uv -n "__fish_seen_subcommand_from venv" -s "c" -l "clear" -d "Remove any existing files or directories at the target path [env: UV_VENV_CLEAR=]"
...
complete -c uv -n "__fish_seen_subcommand_from venv" -l "exclude-newer-package" -d "Limit candidate packages for a specific package to those that were uploaded prior to the given date" -x
...
complete -c uv -n "__fish_seen_subcommand_from venv" -l "native-tls" -d "Whether to load TLS certificates from the platform's native store [env: UV_NATIVE_TLS=]"
...
complete -c uv -n "__fish_seen_subcommand_from venv" -l "directory" -d "Change to the given directory prior to running the command [env: UV_WORKING_DIR=]" -r
complete -c uv -n "__fish_seen_subcommand_from venv" -l "project" -d "Discover a project in the given directory [env: UV_PROJECT=]" -r
...
complete -c uv -n "__fish_seen_subcommand_from build" -l "clear" -d "Clear the output directory before the build, removing stale artifacts"
complete -c uv -n "__fish_seen_subcommand_from build" -l "no-create-gitignore" -d "Do not create a `.gitignore` file in the output directory"
...
complete -c uv -n "__fish_seen_subcommand_from build" -l "exclude-newer-package" -d "Limit candidate packages for specific packages to those that were uploaded prior to the given date" -x
...
complete -c uv -n "__fish_seen_subcommand_from build" -l "no-sources-package" -d "Don't use sources from the `tool.uv.sources` table for the specified packages [env: UV_NO_SOURCES_PACKAGE=]" -x
...
complete -c uv -n "__fish_seen_subcommand_from build" -l "config-settings-package" -d "Settings to pass to the PEP 517 build backend for a specific package, specified as `PACKAGE:KEY=VALUE` pairs" -x
...
complete -c uv -n "__fish_seen_subcommand_from build" -l "native-tls" -d "Whether to load TLS certificates from the platform's native store [env: UV_NATIVE_TLS=]"
...
complete -c uv -n "__fish_seen_subcommand_from build" -l "directory" -d "Change to the given directory prior to running the command [env: UV_WORKING_DIR=]" -r
complete -c uv -n "__fish_seen_subcommand_from build" -l "project" -d "Discover a project in the given directory [env: UV_PROJECT=]" -r
...
complete -c uv -n "__fish_seen_subcommand_from publish" -l "trusted-publishing" -d "Configure trusted publishing [possible values: automatic, always, never]" -x
...
complete -c uv -n "__fish_seen_subcommand_from publish" -l "dry-run" -d "Perform a dry run without uploading files"
complete -c uv -n "__fish_seen_subcommand_from publish" -l "no-attestations" -d "Do not upload attestations for the published files [env: UV_PUBLISH_NO_ATTESTATIONS=]"
...
complete -c uv -n "__fish_seen_subcommand_from publish" -l "native-tls" -d "Whether to load TLS certificates from the platform's native store [env: UV_NATIVE_TLS=]"
...
complete -c uv -n "__fish_seen_subcommand_from publish" -l "directory" -d "Change to the given directory prior to running the command [env: UV_WORKING_DIR=]" -r
complete -c uv -n "__fish_seen_subcommand_from publish" -l "project" -d "Discover a project in the given directory [env: UV_PROJECT=]" -r
...
complete -c uv -n "__fish_seen_subcommand_from cache" -l "native-tls" -d "Whether to load TLS certificates from the platform's native store [env: UV_NATIVE_TLS=]"
...
complete -c uv -n "__fish_seen_subcommand_from cache" -l "directory" -d "Change to the given directory prior to running the command [env: UV_WORKING_DIR=]" -r
complete -c uv -n "__fish_seen_subcommand_from cache" -l "project" -d "Discover a project in the given directory [env: UV_PROJECT=]" -r
...
complete -c uv -n "__fish_seen_subcommand_from self" -l "native-tls" -d "Whether to load TLS certificates from the platform's native store [env: UV_NATIVE_TLS=]"
...
complete -c uv -n "__fish_seen_subcommand_from self" -l "directory" -d "Change to the given directory prior to running the command [env: UV_WORKING_DIR=]" -r
complete -c uv -n "__fish_seen_subcommand_from self" -l "project" -d "Discover a project in the given directory [env: UV_PROJECT=]" -r
